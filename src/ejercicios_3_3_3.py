...
def conjuntos_potencias(conjunto_original: set )  -> list:
    ...
    for elemento in conjunto_original:
        ...
        for subconjunto in lista_potencia:
            ...
            nuevo_subconjunto.append({elemento} | subconjunto)
        
        # TODO: Agregar los nuevos subconjuntos a la lista potencia:
        lista_potencia.extend(nuevo_subconjunto)
...
def main():
    ...
    lista_portencia  = conjuntos_potencias(conjunto_original)
    # TODO: Muestra la lista resultante del conjunto potencia en consola:
    print(lista_portencia)
